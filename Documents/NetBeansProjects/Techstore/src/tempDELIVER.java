 ...
 * @author SNDJ
 */
public class tempDELIVER extends javax.swing.JFrame {

    private User user;
    /**
     * Creates new form tempDELIVER
     */
    public tempDELIVER() {
        initComponents();
    }

    tempDELIVER(User user) {
        this.user = user;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tempDELIVER.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tempDELIVER().setVisible(true);
            }
        });
    }
